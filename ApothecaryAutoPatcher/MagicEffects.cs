...
public static class MagicEffectInfo
{
    ...
    public static readonly Effect AlchFortifyUnarmed        = new(Skyrim.MagicEffect.AlchFortifySmithing,       3.3300000f,  60); //MAG_AlchFortifyUnarmed
    ...
    public static readonly Effect AlchSilence               = new(Skyrim.MagicEffect.AlchDamageMagickaRate,     3.3300000f,  30); //MAG_AlchSilence
